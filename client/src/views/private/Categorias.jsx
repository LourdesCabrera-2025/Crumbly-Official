      ...
      <div className="drawer lg:drawer-open fixed top-0 left-0 ">
        ...
        <div className="drawer-content">
          ...
          <div className="drawer-content h-screen overflow-y-auto">
            ...
            <div className="!p-4">
              <Tabs columns={columns} data={categoria} />
            </div>
          </div>
        </div>
        ...
        is-drawer-close:tooltip is-drawer-close:tooltip-right"
                  ...
                  <ul className=" is-drawer-close:!hidden !pl-2 fle flex-col gap-2  ">
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/usuarios/usuario-local")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/usuarios/usuarios-firebase")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/usuarios/niveles-usuario")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                ...
                <details className="w-full overflow-visible">
                  ...
                  <ul className="is-drawer-close:!hidden !pl-2 flex flex-col gap-1">
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/productos/estado-producto")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/productos/categorias")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() => navigate("/private/productos/ofertas")}
                        className="w-full"
                        id="link-sidebar"
                      >
                        Ofertas
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/productos/valoraciones")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
              ...
              <li className="li-sidebar">
                <details className="w-full overflow-visible">
                  ...
                  <ul className="is-drawer-close:!hidden !pl-2 flex flex-col gap-3">
                    <li className="li-sidebar2">
                      <a
                        onClick={() => navigate("/private/pedidos")}
                        className="w-full"
                        id="link-sidebar"
                      >
                        Lista de pedidos
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/pedidos/detalle-pedido")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/pedidos/estado-pedido")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate("/private/pedidos/metodo-de-pago")
                        }
                        className="w-full"
                        id="link-sidebar"
                      >
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() => navigate("/private/pedidos/entregas")}
                        className="w-full"
                        id="link-sidebar"
                      >
                        Entrega
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() => navigate("/private/pedidos/pagos")}
                        className="w-full"
                        id="link-sidebar"
                      >
                        Pagos
                  ...
                  <ul className="is-drawer-close:!hidden !pl-2 flex flex-col gap-3">
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate(
                            "/private/ubicaciones/administrar-direcciones"
                          )
                        }
                        className="w-full"
                        id="link-sidebar"
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate(
                            "/private/ubicaciones/administrar-departamentos"
                          )
                        }
                        className="w-full"
                        id="link-sidebar"
                    ...
                    <li className="li-sidebar2">
                      <a
                        onClick={() =>
                          navigate(
                            "/private/ubicaciones/administrar-municipios"
                          )
                        }
                        className="w-full"
                        id="link-sidebar"
              ...
              <li className="li-sidebar">
                <button
                  ...
                  id="btn-hover"
                  onClick={() =>
                    navigate("/private/usuarios/actividad-usuarios")
                  }
                >
