...
import DashboardChart from "../../components/private/charts.jsx";
        ...
        <div className="drawer-content">
          ...
          <div className="drawer-content h-screen overflow-y-auto">
            ...
            >
              ...
              <span className="nameDashboard">Cregan</span>
            </div>
            <div className="!p-4 flex justify-center md:items-center sm:items-center gap-4 ">
              {cardsDataInfo.map((item, index) => (
                <div
                  key={item.id || index}
                  className="card w-96 bg-white card-sm shadow-sm "
                >
                  <div className="card-body  ">
                    <div
                      className="card-title !-mt-4 menu-title"
                      id="title-card"
                    >
                      {item.title}
                    </div>
                    <div className="flex justify-between items-center ">
                      <div className="information !mt-4 ">
                        <p className="quantity-information font-stretch-50%">
                          {item.count.toLocaleString()}
                        </p>
                      </div>
                      <div className="indicator !mt-4.5 !mr-3 w-full">
                        <span className="indicator-item  badge badge-primary opacity-40 w-[3rem]">
                          {item.badge}
                        </span>
                      </div>
                    </div>
              ...
              <li className="li-sidebar">
                <details className="w-full overflow-visible">
                  ...
                  <ul className="is-drawer-close:!hidden !pl-2 flex flex-col gap-1">
                    ...
                    <li className="li-sidebar2">
                      <a onClick={()=> navigate("/private/categorias")} className="w-full" id="link-sidebar">
                        Categorias
                      </a>
                    </li>
                    <li className="li-sidebar2">
                    ...
                    <li className="li-sidebar2">
                      <a onClick={() => navigate("/private/Comentarios")} className="w-full" id="link-sidebar">
                        Valoraciones
                      </a>
                    </li>
                  </ul>
